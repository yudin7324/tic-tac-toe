  ...
  return (
    <svg width="72" height="32" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd">
        ...
        <path d="M56.1 0c8.765 0 15.87 7.106 15.87 15.87 0 8.766-7.105 15.871-15.87 15.871-8.765 0-15.87-7.105-15.87-15.87C40.23 7.106 47.334 0 56.1 0Zm0 9.405a6.466 6.466 0 1 0 0 12.931 6.466 6.466 0 0 0 0-12.931Z" fill="#F2B137" fillRule="nonzero"/>
      </g>
    </svg>
  )
}
